...
type _PDUSessionChargingInformation PDUSessionChargingInformation
...
func (o *PDUSessionChargingInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varPDUSessionChargingInformation := _PDUSessionChargingInformation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPDUSessionChargingInformation)

	if err != nil {
		return err
	}

	*o = PDUSessionChargingInformation(varPDUSessionChargingInformation)
