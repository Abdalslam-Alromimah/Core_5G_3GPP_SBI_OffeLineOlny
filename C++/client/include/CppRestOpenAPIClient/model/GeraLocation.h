...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GeraLocation_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GeraLocation_H_
...
public:
    ...
    /// </summary>
    utility::string_t getLocationNumber() const;
    bool locationNumberIsSet() const;
    void unsetLocationNumber();

    void setLocationNumber(const utility::string_t& value);
    ...
    /// </summary>
    utility::string_t getVlrNumber() const;
    bool vlrNumberIsSet() const;
    void unsetVlrNumber();

    void setVlrNumber(const utility::string_t& value);

    /// <summary>
    /// MSC number. See 3GPP TS 23.003 clause 5.1.
    /// </summary>
    utility::string_t getMscNumber() const;
    bool mscNumberIsSet() const;
    void unsetMscNumber();

    void setMscNumber(const utility::string_t& value);
...
protected:
    utility::string_t m_LocationNumber;
    ...
    bool m_RaiIsSet;
    utility::string_t m_VlrNumber;
    bool m_VlrNumberIsSet;
    utility::string_t m_MscNumber;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GeraLocation_H_ */
