...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Ecgi_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Ecgi_H_
...
public:
    ...
    /// </summary>
    utility::string_t getEutraCellId() const;
    bool eutraCellIdIsSet() const;
    void unsetEutraCellId();

    void setEutraCellId(const utility::string_t& value);
...
protected:
    ...
    bool m_PlmnIdIsSet;
    utility::string_t m_EutraCellId;
    bool m_EutraCellIdIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Ecgi_H_ */
