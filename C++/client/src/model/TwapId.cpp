...
web::json::value TwapId::toJson() const
{
...
bool TwapId::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TwapId::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TwapId::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t TwapId::getSsId() const
{
    return m_SsId;
}

void TwapId::setSsId(const utility::string_t& value)
{
    m_SsId = value;
    m_SsIdIsSet = true;
}

bool TwapId::ssIdIsSet() const
{
    return m_SsIdIsSet;
}

void TwapId::unsetSsId()
{
    m_SsIdIsSet = false;
}
utility::string_t TwapId::getBssId() const
{
    return m_BssId;
}

void TwapId::setBssId(const utility::string_t& value)
{
    m_BssId = value;
    m_BssIdIsSet = true;
}
...
utility::string_t TwapId::getCivicAddress() const
{
    return m_CivicAddress;
}

void TwapId::setCivicAddress(const utility::string_t& value)
{
