...
web::json::value Ecgi::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("eutraCellId"))] = ModelBase::toJson(m_EutraCellId);
    }
    if(m_NidIsSet)
    {
...
bool Ecgi::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("eutraCellId"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("eutraCellId")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setEutraCellId;
            ok &= ModelBase::fromJson(fieldValue, refVal_setEutraCellId);
            setEutraCellId(refVal_setEutraCellId);
        }
    }
...
void Ecgi::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_EutraCellIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("eutraCellId")), m_EutraCellId));
    }
    if(m_NidIsSet)
    {
...
bool Ecgi::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("eutraCellId"))))
    {
        utility::string_t refVal_setEutraCellId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("eutraCellId"))), refVal_setEutraCellId );
        setEutraCellId(refVal_setEutraCellId);
    }
