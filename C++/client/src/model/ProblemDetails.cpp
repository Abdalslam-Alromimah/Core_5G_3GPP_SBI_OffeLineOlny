...
web::json::value ProblemDetails::toJson() const
{
    ...
    if(m_SupportedApiVersionsIsSet)
    {
        val[utility::conversions::to_string_t(U("supportedApiVersions"))] = ModelBase::toJson(m_SupportedApiVersions);
    }
    if(m_NoProfileMatchInfoIsSet)
    {
        val[utility::conversions::to_string_t(U("noProfileMatchInfo"))] = ModelBase::toJson(m_NoProfileMatchInfo);
    }
...
bool ProblemDetails::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("supportedApiVersions"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("supportedApiVersions")));
        if(!fieldValue.is_null())
        {
            std::vector<utility::string_t> refVal_setSupportedApiVersions;
            ok &= ModelBase::fromJson(fieldValue, refVal_setSupportedApiVersions);
            setSupportedApiVersions(refVal_setSupportedApiVersions);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("noProfileMatchInfo"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("noProfileMatchInfo")));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NoProfileMatchInfo> refVal_setNoProfileMatchInfo;
            ok &= ModelBase::fromJson(fieldValue, refVal_setNoProfileMatchInfo);
            setNoProfileMatchInfo(refVal_setNoProfileMatchInfo);
        }
    }
    return ok;
}
...
void ProblemDetails::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_SupportedApiVersionsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("supportedApiVersions")), m_SupportedApiVersions));
    }
    if(m_NoProfileMatchInfoIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("noProfileMatchInfo")), m_NoProfileMatchInfo));
    }
}
...
bool ProblemDetails::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("supportedApiVersions"))))
    {
        std::vector<utility::string_t> refVal_setSupportedApiVersions;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("supportedApiVersions"))), refVal_setSupportedApiVersions );
        setSupportedApiVersions(refVal_setSupportedApiVersions);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("noProfileMatchInfo"))))
    {
        std::shared_ptr<NoProfileMatchInfo> refVal_setNoProfileMatchInfo;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("noProfileMatchInfo"))), refVal_setNoProfileMatchInfo );
        setNoProfileMatchInfo(refVal_setNoProfileMatchInfo);
    }
    return ok;
}
...
std::vector<utility::string_t>& ProblemDetails::getSupportedApiVersions()
{
    return m_SupportedApiVersions;
}

void ProblemDetails::setSupportedApiVersions(const std::vector<utility::string_t>& value)
{
...
std::shared_ptr<NoProfileMatchInfo> ProblemDetails::getNoProfileMatchInfo() const
{
    return m_NoProfileMatchInfo;
}

void ProblemDetails::setNoProfileMatchInfo(const std::shared_ptr<NoProfileMatchInfo>& value)
{
    m_NoProfileMatchInfo = value;
    m_NoProfileMatchInfoIsSet = true;
}

bool ProblemDetails::noProfileMatchInfoIsSet() const
{
    return m_NoProfileMatchInfoIsSet;
}

void ProblemDetails::unsetNoProfileMatchInfo()
{
    m_NoProfileMatchInfoIsSet = false;
}
}
