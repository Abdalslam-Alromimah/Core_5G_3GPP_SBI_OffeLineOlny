...
org::openapitools::server::model::NgApCause RanNasRelCause::getNgApCause() const
{
    return m_NgApCause;
}
void RanNasRelCause::setNgApCause(org::openapitools::server::model::NgApCause const& value)
{
    m_NgApCause = value;
