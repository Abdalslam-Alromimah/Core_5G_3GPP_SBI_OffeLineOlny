...
org::openapitools::server::model::Tai N3gaLocation::getN3gppTai() const
{
    return m_N3gppTai;
}
void N3gaLocation::setN3gppTai(org::openapitools::server::model::Tai const& value)
{
    m_N3gppTai = value;
...
org::openapitools::server::model::Ipv6Addr N3gaLocation::getUeIpv6Addr() const
{
    return m_UeIpv6Addr;
}
void N3gaLocation::setUeIpv6Addr(org::openapitools::server::model::Ipv6Addr const& value)
{
    m_UeIpv6Addr = value;
...
org::openapitools::server::model::TransportProtocol N3gaLocation::getProtocol() const
{
    return m_Protocol;
}
void N3gaLocation::setProtocol(org::openapitools::server::model::TransportProtocol const& value)
{
    m_Protocol = value;
...
org::openapitools::server::model::TnapId N3gaLocation::getTnapId() const
{
    return m_TnapId;
}
void N3gaLocation::setTnapId(org::openapitools::server::model::TnapId const& value)
{
    m_TnapId = value;
    m_TnapIdIsSet = true;
}
...
org::openapitools::server::model::TwapId N3gaLocation::getTwapId() const
{
    return m_TwapId;
}
void N3gaLocation::setTwapId(org::openapitools::server::model::TwapId const& value)
{
    m_TwapId = value;
    m_TwapIdIsSet = true;
}
...
org::openapitools::server::model::HfcNodeId N3gaLocation::getHfcNodeId() const
{
    return m_HfcNodeId;
}
void N3gaLocation::setHfcNodeId(org::openapitools::server::model::HfcNodeId const& value)
{
    m_HfcNodeId = value;
...
org::openapitools::server::model::LineType N3gaLocation::getW5gbanLineType() const
{
    return m_W5gbanLineType;
}
void N3gaLocation::setW5gbanLineType(org::openapitools::server::model::LineType const& value)
{
