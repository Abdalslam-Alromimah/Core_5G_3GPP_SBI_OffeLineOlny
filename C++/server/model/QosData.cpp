...
org::openapitools::server::model::Arp QosData::getArp() const
{
    return m_Arp;
}
void QosData::setArp(org::openapitools::server::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
...
org::openapitools::server::model::PduSetQosParaRm QosData::getPduSetQosDl() const
{
    return m_PduSetQosDl;
}
void QosData::setPduSetQosDl(org::openapitools::server::model::PduSetQosParaRm const& value)
{
    m_PduSetQosDl = value;
...
org::openapitools::server::model::PduSetQosParaRm QosData::getPduSetQosUl() const
{
    return m_PduSetQosUl;
}
void QosData::setPduSetQosUl(org::openapitools::server::model::PduSetQosParaRm const& value)
{
    m_PduSetQosUl = value;
