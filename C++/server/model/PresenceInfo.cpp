...
bool PresenceInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<org::openapitools::server::model::Tai>& value = m_TrackingAreaList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::Tai& value : value)
            { 
    ...
    if (ecgiListIsSet())
    {
        const std::vector<org::openapitools::server::model::Ecgi>& value = m_EcgiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const org::openapitools::server::model::Ecgi& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (ncgiListIsSet())
    {
        const std::vector<org::openapitools::server::model::Ncgi>& value = m_NcgiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const org::openapitools::server::model::Ncgi& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<org::openapitools::server::model::GlobalRanNodeId>& value = m_GlobalRanNodeIdList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const org::openapitools::server::model::GlobalRanNodeId& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<org::openapitools::server::model::GlobalRanNodeId>& value = m_GlobaleNbIdList;
...
org::openapitools::server::model::PresenceState PresenceInfo::getPresenceState() const
{
    return m_PresenceState;
}
void PresenceInfo::setPresenceState(org::openapitools::server::model::PresenceState const& value)
{
...
std::vector<org::openapitools::server::model::Tai> PresenceInfo::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void PresenceInfo::setTrackingAreaList(std::vector<org::openapitools::server::model::Tai> const& value)
{
...
std::vector<org::openapitools::server::model::Ecgi> PresenceInfo::getEcgiList() const
{
    return m_EcgiList;
}
void PresenceInfo::setEcgiList(std::vector<org::openapitools::server::model::Ecgi> const& value)
{
    m_EcgiList = value;
...
std::vector<org::openapitools::server::model::Ncgi> PresenceInfo::getNcgiList() const
{
    return m_NcgiList;
}
void PresenceInfo::setNcgiList(std::vector<org::openapitools::server::model::Ncgi> const& value)
{
    m_NcgiList = value;
...
std::vector<org::openapitools::server::model::GlobalRanNodeId> PresenceInfo::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfo::setGlobalRanNodeIdList(std::vector<org::openapitools::server::model::GlobalRanNodeId> const& value)
{
...
std::vector<org::openapitools::server::model::GlobalRanNodeId> PresenceInfo::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfo::setGlobaleNbIdList(std::vector<org::openapitools::server::model::GlobalRanNodeId> const& value)
{
