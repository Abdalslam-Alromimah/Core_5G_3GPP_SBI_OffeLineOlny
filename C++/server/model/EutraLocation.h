...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::Ecgi getEcgi() const;
    void setEcgi(org::openapitools::server::model::Ecgi const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::GlobalRanNodeId getGlobalNgenbId() const;
    void setGlobalNgenbId(org::openapitools::server::model::GlobalRanNodeId const& value);
    bool globalNgenbIdIsSet() const;
    void unsetGlobalNgenbId();
    /// <summary>
    /// 
    /// </summary>
    org::openapitools::server::model::GlobalRanNodeId getGlobalENbId() const;
    void setGlobalENbId(org::openapitools::server::model::GlobalRanNodeId const& value);
...
protected:
    ...
    org::openapitools::server::model::Ecgi m_Ecgi;
    ...
    org::openapitools::server::model::GlobalRanNodeId m_GlobalNgenbId;
    bool m_GlobalNgenbIdIsSet;
    org::openapitools::server::model::GlobalRanNodeId m_GlobalENbId;
