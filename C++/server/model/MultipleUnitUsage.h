...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::UsedUnitContainer> getUsedUnitContainer() const;
    void setUsedUnitContainer(std::vector<org::openapitools::server::model::UsedUnitContainer> const& value);
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::PDUAddress getMultihomedPDUAddress() const;
    void setMultihomedPDUAddress(org::openapitools::server::model::PDUAddress const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::UsedUnitContainer> m_UsedUnitContainer;
    bool m_UsedUnitContainerIsSet;
    std::string m_UPFID;
    bool m_UPFIDIsSet;
    org::openapitools::server::model::PDUAddress m_MultihomedPDUAddress;
