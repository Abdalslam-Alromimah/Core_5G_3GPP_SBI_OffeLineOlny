...
org::openapitools::server::model::Tai EutraLocation::getTai() const
{
    return m_Tai;
}
void EutraLocation::setTai(org::openapitools::server::model::Tai const& value)
{
    m_Tai = value;
}
...
org::openapitools::server::model::Ecgi EutraLocation::getEcgi() const
{
    return m_Ecgi;
}
void EutraLocation::setEcgi(org::openapitools::server::model::Ecgi const& value)
{
    m_Ecgi = value;
}
...
org::openapitools::server::model::GlobalRanNodeId EutraLocation::getGlobalNgenbId() const
{
    return m_GlobalNgenbId;
}
void EutraLocation::setGlobalNgenbId(org::openapitools::server::model::GlobalRanNodeId const& value)
{
...
org::openapitools::server::model::GlobalRanNodeId EutraLocation::getGlobalENbId() const
{
    return m_GlobalENbId;
}
void EutraLocation::setGlobalENbId(org::openapitools::server::model::GlobalRanNodeId const& value)
{
    m_GlobalENbId = value;
