...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::QueryParameter> getQueryParams() const;
    void setQueryParams(std::vector<org::openapitools::server::model::QueryParameter> const& value);
...
protected:
    std::vector<org::openapitools::server::model::QueryParameter> m_QueryParams;
