...
bool ProblemDetails::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<org::openapitools::server::model::InvalidParam>& value = m_InvalidParams;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::InvalidParam& value : value)
            { 
...
std::vector<org::openapitools::server::model::InvalidParam> ProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ProblemDetails::setInvalidParams(std::vector<org::openapitools::server::model::InvalidParam> const& value)
{
...
org::openapitools::server::model::AccessTokenErr ProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ProblemDetails::setAccessTokenError(org::openapitools::server::model::AccessTokenErr const& value)
{
...
org::openapitools::server::model::AccessTokenReq ProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ProblemDetails::setAccessTokenRequest(org::openapitools::server::model::AccessTokenReq const& value)
{
...
void ProblemDetails::setSupportedApiVersions(std::vector<std::string> const& value)
{
...
org::openapitools::server::model::NoProfileMatchInfo ProblemDetails::getNoProfileMatchInfo() const
{
    return m_NoProfileMatchInfo;
}
void ProblemDetails::setNoProfileMatchInfo(org::openapitools::server::model::NoProfileMatchInfo const& value)
{
