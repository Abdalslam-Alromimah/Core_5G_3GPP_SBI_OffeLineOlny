...
bool NrLocation::operator==(const NrLocation& rhs) const
{
    ...
    ((!ntnTaiInfoIsSet() && !rhs.ntnTaiInfoIsSet()) || (ntnTaiInfoIsSet() && rhs.ntnTaiInfoIsSet() && getNtnTaiInfo() == rhs.getNtnTaiInfo()))
...
void to_json(nlohmann::json& j, const NrLocation& o)
{
    ...
    if(o.ntnTaiInfoIsSet())
        j["ntnTaiInfo"] = o.m_NtnTaiInfo;
...
void from_json(const nlohmann::json& j, NrLocation& o)
{
    ...
    if(j.find("ntnTaiInfo") != j.end())
    {
        j.at("ntnTaiInfo").get_to(o.m_NtnTaiInfo);
        o.m_NtnTaiInfoIsSet = true;
    } 
    
}

org::openapitools::server::model::Tai NrLocation::getTai() const
{
    return m_Tai;
}
void NrLocation::setTai(org::openapitools::server::model::Tai const& value)
{
    m_Tai = value;
}
org::openapitools::server::model::Ncgi NrLocation::getNcgi() const
{
    return m_Ncgi;
}
void NrLocation::setNcgi(org::openapitools::server::model::Ncgi const& value)
{
    m_Ncgi = value;
}
...
org::openapitools::server::model::GlobalRanNodeId NrLocation::getGlobalGnbId() const
{
    return m_GlobalGnbId;
}
void NrLocation::setGlobalGnbId(org::openapitools::server::model::GlobalRanNodeId const& value)
{
    m_GlobalGnbId = value;
...
org::openapitools::server::model::NtnTaiInfo NrLocation::getNtnTaiInfo() const
{
    return m_NtnTaiInfo;
}
void NrLocation::setNtnTaiInfo(org::openapitools::server::model::NtnTaiInfo const& value)
{
    m_NtnTaiInfo = value;
