...
bool AtsssCapability::operator==(const AtsssCapability& rhs) const
{
    ...
    ((!mpquicIsSet() && !rhs.mpquicIsSet()) || (mpquicIsSet() && rhs.mpquicIsSet() && isMpquic() == rhs.isMpquic())) &&
...
void from_json(const nlohmann::json& j, AtsssCapability& o)
{
    ...
    if(j.find("mpquic") != j.end())
    {
        j.at("mpquic").get_to(o.m_Mpquic);
        o.m_MpquicIsSet = true;
    } 
...
void AtsssCapability::setMpquic(bool const value)
{
    m_Mpquic = value;
    m_MpquicIsSet = true;
}
