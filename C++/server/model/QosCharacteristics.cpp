...
org::openapitools::server::model::QosResourceType QosCharacteristics::getResourceType() const
{
    return m_ResourceType;
}
void QosCharacteristics::setResourceType(org::openapitools::server::model::QosResourceType const& value)
{
