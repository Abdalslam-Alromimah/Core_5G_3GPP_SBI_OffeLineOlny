...
bool UsedUnitContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<org::openapitools::server::model::std::string>& value = m_EventTimeStamps;
...
std::vector<org::openapitools::server::model::Trigger> UsedUnitContainer::getTriggers() const
{
    return m_Triggers;
}
void UsedUnitContainer::setTriggers(std::vector<org::openapitools::server::model::Trigger> const& value)
{
    m_Triggers = value;
...
std::vector<org::openapitools::server::model::std::string> UsedUnitContainer::getEventTimeStamps() const
{
    return m_EventTimeStamps;
}
void UsedUnitContainer::setEventTimeStamps(std::vector<org::openapitools::server::model::std::string> const& value)
{
...
org::openapitools::server::model::PDUContainerInformation UsedUnitContainer::getPDUContainerInformation() const
{
    return m_PDUContainerInformation;
}
void UsedUnitContainer::setPDUContainerInformation(org::openapitools::server::model::PDUContainerInformation const& value)
{
