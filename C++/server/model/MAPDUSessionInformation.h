...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::MaPduIndication getMAPDUSessionIndicator() const;
    void setMAPDUSessionIndicator(org::openapitools::server::model::MaPduIndication const& value);
    bool mAPDUSessionIndicatorIsSet() const;
    void unsetMAPDUSessionIndicator();
    /// <summary>
    /// 
    /// </summary>
    org::openapitools::server::model::AtsssCapability getATSSSCapability() const;
    void setATSSSCapability(org::openapitools::server::model::AtsssCapability const& value);
...
protected:
    org::openapitools::server::model::MaPduIndication m_MAPDUSessionIndicator;
    bool m_MAPDUSessionIndicatorIsSet;
    org::openapitools::server::model::AtsssCapability m_ATSSSCapability;
