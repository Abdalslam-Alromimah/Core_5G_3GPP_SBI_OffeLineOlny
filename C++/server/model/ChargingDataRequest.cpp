...
bool ChargingDataRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_NfConsumerIdentification.validate()) {
        msg << _pathPrefix << ": NfConsumerIdentification is invalid;";
        success = false;
    }         
    ...
    {
        const std::vector<org::openapitools::server::model::MultipleUnitUsage>& value = m_MultipleUnitUsage;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::MultipleUnitUsage& value : value)
            { 
...
org::openapitools::server::model::NFIdentification ChargingDataRequest::getNfConsumerIdentification() const
{
    return m_NfConsumerIdentification;
}
void ChargingDataRequest::setNfConsumerIdentification(org::openapitools::server::model::NFIdentification const& value)
{
...
std::vector<org::openapitools::server::model::MultipleUnitUsage> ChargingDataRequest::getMultipleUnitUsage() const
{
    return m_MultipleUnitUsage;
}
void ChargingDataRequest::setMultipleUnitUsage(std::vector<org::openapitools::server::model::MultipleUnitUsage> const& value)
{
...
std::vector<org::openapitools::server::model::Trigger> ChargingDataRequest::getTriggers() const
{
    return m_Triggers;
}
void ChargingDataRequest::setTriggers(std::vector<org::openapitools::server::model::Trigger> const& value)
{
    m_Triggers = value;
...
org::openapitools::server::model::PDUSessionChargingInformation ChargingDataRequest::getPDUSessionChargingInformation() const
{
    return m_PDUSessionChargingInformation;
}
void ChargingDataRequest::setPDUSessionChargingInformation(org::openapitools::server::model::PDUSessionChargingInformation const& value)
{
...
org::openapitools::server::model::RoamingQBCInformation ChargingDataRequest::getRoamingQBCInformation() const
{
    return m_RoamingQBCInformation;
}
void ChargingDataRequest::setRoamingQBCInformation(org::openapitools::server::model::RoamingQBCInformation const& value)
{
