...
org::openapitools::server::model::PlmnId GlobalRanNodeId::getPlmnId() const
{
    return m_PlmnId;
}
void GlobalRanNodeId::setPlmnId(org::openapitools::server::model::PlmnId const& value)
{
    m_PlmnId = value;
}
...
org::openapitools::server::model::GNbId GlobalRanNodeId::getGNbId() const
{
    return m_GNbId;
}
void GlobalRanNodeId::setGNbId(org::openapitools::server::model::GNbId const& value)
{
    m_GNbId = value;
    m_GNbIdIsSet = true;
}
