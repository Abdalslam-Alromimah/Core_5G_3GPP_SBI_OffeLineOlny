...
org::openapitools::server::model::PduSetHandlingInfo PduSetQosPara::getPduSetHandlingInfo() const
{
    return m_PduSetHandlingInfo;
}
void PduSetQosPara::setPduSetHandlingInfo(org::openapitools::server::model::PduSetHandlingInfo const& value)
{
