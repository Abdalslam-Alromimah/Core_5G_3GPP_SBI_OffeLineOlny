...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::QosResourceType getResourceType() const;
    void setResourceType(org::openapitools::server::model::QosResourceType const& value);
    /// <summary>
...
protected:
    ...
    org::openapitools::server::model::QosResourceType m_ResourceType;
